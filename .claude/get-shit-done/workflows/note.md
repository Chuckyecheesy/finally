...
- **Global scope**: `/Users/williamshi/Projects/finally/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/williamshi/Projects/finally/.claude/notes/`)
...
2. Glob `/Users/williamshi/Projects/finally/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/williamshi/Projects/finally/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/williamshi/Projects/finally/.claude/notes/` — works in any directory
