...
```
Agent(
  prompt="Read /Users/williamshi/Projects/finally/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/williamshi/Projects/finally/.claude/get-shit-done/templates/SECURITY.md`
