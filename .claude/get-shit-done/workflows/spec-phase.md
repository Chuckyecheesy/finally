...
```bash
INIT=$(node "/Users/williamshi/Projects/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/williamshi/Projects/finally/.claude/get-shit-done/templates/spec.md.
