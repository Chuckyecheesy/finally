...
```bash
INIT=$(node "/Users/williamshi/Projects/finally/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/williamshi/Projects/finally/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
